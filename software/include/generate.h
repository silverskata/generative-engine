...
typedef struct
{
    ...
    uint16_t delay;          //how many cycles should the generator wait after a change is made.
    ...
    bool possible_val[12]; //Array of possible values that the generator can set.
} generator_t;
